...
public class ProductDaoImpl implements IProductDao {
    ...
    public Product findProductById(int productId) {
       Product product=sqlSession.selectOne("com.neuedu.dao.IProductDao.findProductById",productId);
        return product;
    }
    ...
    public List<Product> findPrdouctByPrdouctIdOrProductName(Integer productId, String productName,Integer pageNo,Integer pageSize) {
        ...
        map.put("offSet",(pageNo-1)*pageSize);
        map.put("pageSize",pageSize);
        return sqlSession.selectList("com.neuedu.dao.IProductDao.findPrdouctByPrdouctIdOrProductName",map);
    ...
    public Long findTotalRecordByIdOrByName(Integer productId, String productName) {
        ...
        map.put("productId",productId);
        map.put("productName",productName);
        return sqlSession.selectOne("com.neuedu.dao.IProductDao.findTotalRecordByIdOrByName",map);
    ...
    public List<Product> findProductBycategoryIdsAndProductName(Set<Integer> categoryIds, String productName, Integer pageNo, Integer pageSize,int orderby) {
        ...
        return sqlSession.selectList("com.neuedu.dao.IProductDao.findProductBycategoryIdsAndProductName",map);
    }
    ...
    public Long findTotalRecordByIdAndByName(Set<Integer> categoryIds, String productName) {
        ...
        map.put("categoryIds",categoryIds);
        map.put("productName",productName);
        return sqlSession.selectOne("com.neuedu.dao.IProductDao.findTotalRecordCategoryIdsAndproductName",map);

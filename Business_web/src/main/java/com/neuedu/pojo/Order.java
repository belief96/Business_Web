...
public class Order {
    ...
    public Order(Integer id, Long order_no, Integer user_id, Integer shopping_id, BigDecimal payment, Integer payment_type, Integer postage, Integer status, Date payment_time, Date send_time, Date end_time, Date close_time, Date create_time, Date update_time) {
        this.id = id;
